...
```bash
   repo init -u https://github.com/zawzaww/pure-aospandroid.git -b android-8.1.0
```
...
```bash
   repo init --depth=1 -u https://github.com/zawzaww/pure-aospandroid.git -b android-8.1.0
```
